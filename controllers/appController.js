...
module.exports = {
    ...
    Thought.create(req.body)
      ...
      .then((user) =>
        !user
          ...
          : res.json('Created the thought under user provided')
      )
      .catch((err) => {
        console.log(err);
  ...
  // Updates and application using the findOneAndUpdate method. 
  //Uses the ID, and the $set operator in mongodb to inject 
  //the request body. Enforces validation.
